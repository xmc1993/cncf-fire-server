...
public class ManageLeaveMessageController {
    ...
    @ResponseBody
    public ResponseData updateMessageSetValid(@ApiParam("留言集ID") @RequestParam int id, @ApiParam("是否通过审核") @RequestParam int valid){
    ...
    @ResponseBody
    public ResponseData<Boolean> updateMessageValid(@ApiParam("本条留言的ID") @RequestParam int id,@ApiParam("是否通过审核") @RequestParam int valid){
